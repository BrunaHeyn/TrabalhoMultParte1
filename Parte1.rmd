...
#Introdução
 ...
 O objetivo do estudo é comparar as duas espécies de moscas com as demais variáveis de interesse para saber se há diferença entre esses dois grupos e, se houver, em que variáveis reside(m) essa(s) diferença(s).
